    ...
    >
      <ol className="inline-flex whitespace-nowrap flex-nowrap items-center space-x-1 md:space-x-1">
        <li className="inline-flex items-center">
          <Link href="/" passHref className="transition-all inline-flex items-center text-gray-600 dark:text-neutral-300 hover:text-gray-800 dark:hover:text-neutral-200">
              ...
              <li key={index}>
                <div className="flex items-center">
                  ...
                  <Link
                    ...
                    className="transition-all ml-1 text-gray-600 dark:text-neutral-300 hover:text-gray-800 dark:hover:text-neutral-200"
                  >
                    {capitalizeFirstLetter(path)}
                  </Link>
                </div>

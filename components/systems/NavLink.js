...
export default function NavLink({ className, href, icon, isHome, children }) {
    ...
    return (
      <Link passHref href={href}
        className={clsx(className,
          "transition-all w-full px-3 py-2 flex justify-start items-center gap-2 rounded text-sm focus-visible:outline-none focus-visible:ring focus-visible:ring-emerald-500",
  ...
  return (
    <Link passHref href={href}
      className={`${className} transition-all w-full px-3 py-2 flex justify-start items-center gap-2 rounded text-sm focus-visible:outline-none focus-visible:ring focus-visible:ring-emerald-500
       ${router.pathname.includes(href) && !isHome ?
          ...
          router.pathname === href && isHome ?
            ...
            :
            // not current route
            "text-gray-700 dark:text-neutral-300 hover:text-emerald-600 dark:hover:text-emerald-500 hover:bg-gray-100 dark:hover:bg-neutral-800"
        }`}
    >
      {icon}
      <span>{children}</span>
...
NavLink.logout = ({ href, icon, className, children }) => {
  return (
    <Link passHref href={href} className={clsx(className,
      "transition-all w-full px-4 py-2 flex justify-start items-center",
      "gap-3 text-sm rounded hover:bg-red-100 dark:hover:bg-neutral-800",

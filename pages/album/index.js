    ...
    () => [
      ...
      },
      {
        ...
        Cell: (row) => {
          ...
          return (
            <Link href={`album/detail/${values.id}`} className="hover:text-emerald-500 text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-emerald-500 rounded transition-all duration-200">
              {values.name}
            </Link>
          )
        }

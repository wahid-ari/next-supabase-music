          ...
          {data.map((item, index) => {
            return (
              <TableSimple.tr key={index}>
                ...
                <TableSimple.td>
                  <Link href={`genre/detail/${item.id}`} className="hover:text-emerald-500 text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-emerald-500 rounded transition-all duration-200">
                    {item.name}
                  </Link>  
                </TableSimple.td>
                <TableSimple.td>
